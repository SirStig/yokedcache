...
class CacheConnectionError(YokedCacheError):
    ...
    def __init__(self, message: str = "Failed to connect to Redis", details: Optional[dict] = None) -> None:
...
class CacheKeyError(YokedCacheError):
    ...
    def __init__(self, key: str, operation: str = "unknown", details: Optional[dict] = None) -> None:
...
class CacheSerializationError(YokedCacheError):
    ...
    def __init__(self, data_type: str, operation: str, original_error: Optional[Exception] = None) -> None:
...
class CacheInvalidationError(YokedCacheError):
    ...
    def __init__(self, target: str, invalidation_type: str = "unknown", details: Optional[dict] = None) -> None:
...
class CacheConfigurationError(YokedCacheError):
    ...
    def __init__(self, config_key: str, issue: str, details: Optional[dict] = None) -> None:
...
class CacheTimeoutError(YokedCacheError):
    ...
    def __init__(self, operation: str, timeout: float, details: Optional[dict] = None) -> None:
